    ...
    <div class="col-lg-12">
        ...
        <div class="ibox tooltip-demo">
            <div class="ibox-title">
                <i class="fa fa-database"></i> <span>Tambah Mata Pelajaran</span>
            </div>
                ...
                <form role="form" action="" method="POST">
                    <div class="container">
                        <div class="form-group  row">
                            ...
                            <div class="col-sm-10">
                                <input id="idmatapelajaran" name="idmatapelajaran" type="text" class="form-control input-sm" value="<?= set_value('idmatapelajaran') ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input id="matapelajaran" name="matapelajaran" type="text" class="form-control input-sm" value="<?= set_value('matapelajaran') ?>">
            ...
            <div class="ibox-footer">
                <div class="pull-right">
                    <a href="<?= base_url() ?>indukdata/matapelajaran_c" class="btn btn-danger btn-xs text-white" style="margin-top: -5px;">
                        Batal</a>
                    <button type="submit" name="tambahmatapelajaran" class="btn btn-primary btn-xs" style="margin-top: -5px;">
                        Simpan</button>
                </div>
                &nbsp;
            </div>
